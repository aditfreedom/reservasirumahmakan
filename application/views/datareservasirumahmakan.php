	...
	foreach ($tb_reservasi as $datareservasi) : ?>
		<tr class="nomor text-center">
            <th scope="row"><?php echo $i ;?></th>
                  ...
                  <td><?php echo $datareservasi->total_harga;?></td>
                  ...
                  <td><?php echo anchor('dashboardrumahmakan/editreservasirumahmakan/'.$datareservasi->id_reservasi,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>')?></td>	
                  </tr>
