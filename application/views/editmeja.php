...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">EDIT STATUS MEJA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <?php foreach ($status as $statusmeja) : ?>
		<form method="post" action="<?php echo base_url().'dashboard/updatemeja'; ?>">
        ...
        <input type="text" name="nama_rm" class="form-control" value="<?php echo $statusmeja->nama_rm;?>" readonly>
        </div>
        <div class="form-group">
        <label for="">No Meja</label>
        <input type="text" name="no_meja" class="form-control" value="<?php echo $statusmeja->no_meja;?>" readonly>
        </div>
        <div class="form-group">
        <label for="">Kapasitas</label>
        <input type="text" name="kapasitas" class="form-control" value="<?php echo $statusmeja->kapasitas;?>" readonly>
        </div>
        <div class="form-group">
