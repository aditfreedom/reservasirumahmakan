...
<div class="nav-rm fixed-top text-center font-weight-bold" style="margin-bottom:10px;">STATUS RESERVASI</div>
...
<?php $i = 1;   
  ...
  <div class="row">
    ...
    ?>
    <tr><td valign="top" style="padding-left:5px; "><a class="btn-rm <?= $class;?>" href="#" role="button" style="width:60px;"><?php echo $datarm->status_reservasi?></a></td></tr> 
