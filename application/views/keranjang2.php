...
<div class="nav-rm fixed-top text-center font-weight-bold" style="margin-bottom:10px;">DAFTAR KERANJANG</div>

<?php $i = 1;   
  foreach ($tb_reservasi as $datarm) : ?>
  <div class="row">
    <div class="col">
    <a class="btn-rm btn text-dark" href="<?php echo base_url()?>dashboardandroid/bayarkeranjang/<?=$datarm->id_reservasi;?>" role="button" style="width:100%;height:120px;margin-bottom:10px;text-align: left !important;">
    <table>
    <tr>
    </tr>
    ...
    <tr><td valign="top" style="padding-left:5px; "> <?php echo $datarm->nama_rm;?>
    <tr><td valign="top" style="padding-left:5px; ">Rp. <?php echo $datarm->total_harga;?>
    <tr><td valign="top" style="padding-left:5px; "><a class="btn-rm btn-danger text-light  " href="#" role="button" style="width:60px;"><?php echo $datarm->status_bayar?></a></td></tr> 
