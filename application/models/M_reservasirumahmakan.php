...
class M_reservasirumahmakan extends CI_Model{
    ...
    public function ambilreservasi($where){
        return $this->db->get_where('tb_reservasi',$where);  
    }
...
public function ambil_datapengguna($where)
{
   ...
   {
       return $this->db->get_where('tb_rekening',$id);  
   }
 ...
 public function inputpengguna1($data)
 {
